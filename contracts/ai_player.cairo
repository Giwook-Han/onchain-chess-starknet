...
func rec2{
    syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr, bitwise_ptr : BitwiseBuiltin*
}(board : Uint256, aMovesArray : Uint256, depth : Uint256) -> (
    bestScore : felt, bestMove : Uint256
):
    alloc_locals
...
func evaluateMove{
    ...
    let newFromIndex : Uint256 = Uint256(6 * topOfTheFromIndex.low + bottomOfTheFromIndex.low - 7,0)
